...
export default class MobileWebGL {
  ...
  updateState(page) {
    ...
    } else if (this._page === pages.ABOUT || this._page === pages.CODE || this._page === pages.CONCEPT || this._page === pages.GENESIS || this._page === pages.IBM || this._page === pages.MECH || this._page === pages.QUIZ || this._page === pages.ROBO || this._page === pages.STRG || this._page === pages.TECH || this._page === pages.LOGIN  || this._page === pages.MYKTJ  || this._page === pages.WORKSHOP) {
