...
import template from './mobile_genesis.tpl.html';
import './mobile_genesis.scss';
import axios from 'axios';


@visible()
@active()
export default class MobileGenesis {
  ...
  constructor(options) {
    ...
    this._ui = {
      ...
      tabcontainer: this._el.querySelector('.genesis__tab'),
      tabcontentcontainer: this._el.querySelector('.genesis__tabcontent__container')
    };
