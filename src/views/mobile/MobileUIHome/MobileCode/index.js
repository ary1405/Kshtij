...
import template from './mobile_code.tpl.html';
import './mobile_code.scss';
import axios from 'axios';


@visible()
@active()
export default class MobileCode {
  ...
  constructor(options) {
    ...
    this._ui = {
      ...
      tabcontainer: this._el.querySelector('.code__tab'),
      tabcontentcontainer: this._el.querySelector('.code__tabcontent__container')
    };
