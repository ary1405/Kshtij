...
import template from './mobile_strg.tpl.html';
import './mobile_strg.scss';
...
@visible()
@active()
export default class MobileStrg {
  ...
  constructor(options) {
    ...
    this._ui = {
      ...
      tabcontainer: this._el.querySelector('.strg__tab'),
      tabcontentcontainer: this._el.querySelector('.strg__tabcontent__container')
    };
