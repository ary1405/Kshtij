...
import template from './mobile_robo.tpl.html';
import './mobile_robo.scss';
...
@visible()
@active()
export default class MobileRobo {
  ...
  constructor(options) {
    ...
    this._ui = {
      ...
      tabcontainer: this._el.querySelector('.robo__tab'),
      tabcontentcontainer: this._el.querySelector('.robo__tabcontent__container')
    };
