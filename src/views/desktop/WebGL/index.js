...
export default class WebGL {
  ...
  updateState(page) {
    ...
    } else if (page === pages.ABOUT || pages.QUIZ || pages.CONCEPT || pages.CODE || pages.ROBO || pages.MECH || pages.STRG || pages.IBM || pages.TECH || pages.TEAM || pages.LOGIN || pages.MYKTJ || pages.WORKSHOP) {
