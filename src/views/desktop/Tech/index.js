...
import template from './tech.tpl.html';
import './tech.scss';
...
@visible()
@active()
export default class DesktopTechView {
  ...
  constructor(options) {
    ...
    this._ui = {
      ...
      tabcontainer: this._el.querySelector('.tech__tab'),
      tabcontentcontainer: this._el.querySelector('.tech__tabcontent__container')
    };
