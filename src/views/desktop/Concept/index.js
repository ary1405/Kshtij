...
import template from './concept.tpl.html';
import './concept.scss';
...
@visible()
@active()
export default class DesktopConceptView {
  ...
  constructor(options) {
    ...
    this._ui = {
      ...
      tabcontainer: this._el.querySelector('.concept__tab'),
      tabcontentcontainer: this._el.querySelector('.concept__tabcontent__container')
    };
